 ...
 * @LastEditTime: 2023-12-27 10:30:16
...
`
    ...
    return (
        <>
            <Paper>
                <div className="centered" ref={box} />
            </Paper>
            <Note>
                <div>
                    <p>
                        hands-on
                        <a className="ml-3" href='https://threejs.org/' target='_blank'>three.js</a>
                    </p>
                    <br />
                    <p >
                        following
                        <a className="ml-3" href='https://tympanus.net/codrops/2020/03/17/create-a-wave-motion-effect-on-an-image-with-three-js/' target='_blank'>this guide</a>
                    </p>
                </div>
            </Note>
